...
export default function Thumbnails() {
  ...
  const handleDeleteThumbnail = async () => {
    ...
    if (success) {
      ...
      toast.success("Thumbnail deleted", { description: "Your thumbnail has been deleted successfully." })
    } else {
      toast.error("Error deleting thumbnail", { description: "Could not delete the thumbnail. Please try again." })
    }
