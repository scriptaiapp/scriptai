        ...
        <main className="relative flex min-h-screen w-full flex-col bg-slate-50 text-slate-900 md:flex-row">
            ...
            <div className="absolute left-4 top-4 z-10 md:left-6 md:top-6">
                <Button
                    variant="ghost"
                    onClick={() => router.back()}
                    className="text-slate-600 hover:bg-slate-200 hover:text-purple-600"
                >
            ...
            <div className="flex w-full flex-col items-start justify-center p-8 text-center md:w-1/2 md:p-12 md:text-left lg:p-16">
                <h1 className="text-6xl font-extrabold tracking-tight text-slate-900 sm:text-7xl lg:text-8xl">
                    Lost in Space?
                </h1>
                ...
                <div className="mt-10 flex flex-col items-center gap-6 sm:flex-row sm:items-start">
                    <Link
                        href="/"
                        className="group inline-flex items-center gap-2 text-lg font-semibold text-purple-600 transition-colors hover:text-purple-800"
                    >
            ...
            <div className="relative flex w-full items-center justify-center overflow-hidden p-8 md:w-1/2">
                <Image
                    src={error404}
                    alt="Astronaut floating in space, 404 error"
                    className="absolute inset-0 h-full w-full object-contain animate-slow-pan z-0"
                    priority
                />
